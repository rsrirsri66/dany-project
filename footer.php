    ...
    <div class="container">
        <div class="footer_wrapper d-sm-flex flex-wrap flex-lg-nowrap justify-content-lg-between">
            ...
            <div class="footer_block col-sm-6 col-lg-auto" data-order="1">
                <div class="logo logo--footer">
                    <a class="d-inline-flex align-items-center" href="index.php">
                        ...
                        <span class="text">
                            ...
                            <span class="text_secondary">Staccato</span>
                        </span>
                    </a>
                </div>
                <p class="footer_block-text">
                    At <strong>DynamicStaccato Musical Academy</strong>, we help you unlock your true potential in music. 
                    From Piano to Guitar, Drums, Violin, and Vocals — our expert mentors guide you every step of the way.
                </p>
                ...
                <div class="wrapper d-flex flex-column">
                    ...
                    <a class="link link--contacts text text--sm d-inline-flex align-items-center"
                        ...
                        <i class="icon-phone-solid icon"></i> +91-98765-43210
                    </a>
                </div>
            </div>
            ...
            <div class="footer_block col-sm-6 col-lg-auto" data-order="2">
                <h5 class="footer_block-header">Quick Links:</h5>
                <ul class="footer_block-nav">
                    <li class="footer_block-nav_item"><a class="link" href="about.php">About Us</a></li>
                    <li class="footer_block-nav_item"><a class="link" href="courses.php">Our Courses</a></li>
                    <li class="footer_block-nav_item"><a class="link" href="pricing.php">Events & Workshops</a></li>
                    <!-- <li class="footer_block-nav_item"><a class="link" href="gallery.php">Gallery</a></li>
                    <li class="footer_block-nav_item"><a class="link" href="faq.php">FAQ</a></li> -->
                    <li class="footer_block-nav_item"><a class="link" href="contacts.php">Contact</a></li>
                </ul>
            </div>
